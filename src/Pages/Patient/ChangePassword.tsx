  ...
  return (
    ...
    {success && <Alert severity="success">{success}</Alert>}
      ...
      <TextField
        ...
        onBlur={(e) =>
          !e.target.value
            ? setoldPasswordErrorMsg(true)
            : setoldPasswordErrorMsg(false)
            
        }
        sx={{ mt: 2 }}
      />
        {oldpasswordErrorMsg && <span style={{ color: "red" }}>Current Password cannot be empty!</span>}
      <TextField
        id="outlined-basic"
        type="password"
        label="New Password"
        ...
        sx={{ mt: 2 }}
      />
      {passwordErrorMsg && <span style={{ color: "red" }}>New Password cannot be empty!</span>}
      <TextField
        id="outlined-basic"
        type="password"
