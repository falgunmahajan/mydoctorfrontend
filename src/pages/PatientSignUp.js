...
import {  getDate, matchConfirmPassword, validEmail, validMobile, validName, validPassword } from '../utils/validation';
  ...
  return (
    <div>
      ...
      <form onSubmit={validateSubmit}>
        ...
        <TextField error={nameError} placeholder='Enter Name' fullWidth value={user.name}  inputProps={{ "data-testid": "name" }} 
...
<LocalizationProvider dateAdapter={AdapterDayjs}>
    ...
    <br /><br />
        ...
        <TextField error={mobileError} type="tel" placeholder='Enter Mobile Number' fullWidth value={user.mobileNo} onChange={(e=>setUser({...user,mobileNo:e.target.value}))} 
      ...
      <br /><br />
        ...
        <TextField error={emailError} placeholder='abc@gmail.com' fullWidth value={user.email} inputProps={{ "data-testid": "email" }}
      ...
      {showPasswordRules && <Box sx={{my:1}}>
        <Box>
          {validLowercase=="initial" && <CircleOutlined  fontSize="small" color="primary"/>}
           ...
           {validLowercase=="true" && <CheckCircleOutlineOutlined data-testid="lowercase right" fontSize="small" color="success"/> }
        ...
        {validUpperCase=="initial" && <CircleOutlined fontSize="small" color="primary"/>}
           ...
           {validUpperCase=="true" && <CheckCircleOutlineOutlined data-testid="uppercase right" fontSize="small" color="success"/> } <span>Must contain uppercase letter.</span>
        </Box>
        <Box>
        {validSpecialCharacter=="initial" && <CircleOutlined fontSize="small" color="primary"/>}
           ...
           {validSpecialCharacter=="true" && <CheckCircleOutlineOutlined data-testid="specialcharacter right" fontSize="small" color="success"/> }<span>Must contain at least one special character. </span>
        </Box>
        <Box>
        {validNumber=="initial" && <CircleOutlined fontSize="small" color="primary"/>}
           ...
           {validNumber=="true" && <CheckCircleOutlineOutlined data-testid="digit right" fontSize="small" color="success"/> } <span>Must contain at least one number.</span>
        </Box>
        <Box>
        {validLength=="initial" && <CircleOutlined fontSize="small" color="primary"/>}
           ...
           {validLength=="true" && <CheckCircleOutlineOutlined data-testid="sixchar right" fontSize="small" color="success"/> } <span>Must contain at least 6 characters.</span>
        </Box>
        <Box>
        {matchPassword=="initial" && <CircleOutlined fontSize="small" color="primary"/>}
           ...
           {matchPassword=="true" && <CheckCircleOutlineOutlined data-testid="match right" fontSize="small" color="success"/> }
